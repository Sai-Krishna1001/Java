...
public class BankManagement { // these class provides all
    ...
    // To create a method for CreateAccount
    public static boolean createAccount(String name, int passCode) // create account function
    {
        try {
            ...
            sql = "INSERT INTO customer(cname,balance,pass_code) values(" + name + "," + initial_balance + "," + passCode + ")";
    ...
    // To create a method for loginAccount
